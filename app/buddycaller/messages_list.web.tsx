...
export default function MessagesListScreen() {
  ...
  const handleConversationPress = async (conversation: Conversation) => {
    ...
    // On web, navigate to split-view hub page that shows list + chat side-by-side
    const pathname = '/buddycaller/messages_hub';
    router.push({
      pathname,
      params: {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      {/* Messages List */}
      <ScrollView style={styles.messagesList} contentContainerStyle={{ paddingBottom: rp(16) }} showsVerticalScrollIndicator={true}>
        {loading ? (
...
const styles = StyleSheet.create({
  ...
  conversationName: {
    fontSize: Platform.OS === 'web' ? 14 : rf(15),
    fontWeight: '600',
    color: '#333',
    flex: 1,
    minWidth: 0,
  ...
  timestamp: {
    fontSize: Platform.OS === 'web' ? 11 : rf(11),
    color: '#999',
  },
  ...
  unreadName: {
    fontWeight: '900',
    color: '#000',
    fontSize: Platform.OS === 'web' ? 14 : rf(16),
  },
  ...
  lastMessage: {
    fontSize: Platform.OS === 'web' ? 13 : rf(13),
    color: '#666',
    flex: 1,
    marginRight: rp(8),
    minWidth: 0,
