// app/buddyrunner/errand_details.tsx
...
export default function ErrandDetails() {
            ...
            <ScrollView contentContainerStyle={ui.body}>
                ...
                <View style={s.profileCard}>
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() =>
                            errand?.id &&
                            router.push({ pathname: "/buddyrunner/view_map", params: { id: errand.id } })
                        }
    ...
    return (
        <SafeAreaView style={ui.container}>
            <Header router={router} errandId={id} />
            {content()}
        </SafeAreaView>
    );
}
