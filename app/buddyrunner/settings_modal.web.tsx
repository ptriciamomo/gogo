// app/buddyrunner/settings_modal.web.tsx - Web version of settings modal
...
/* ================= MAIN COMPONENT ================= */
export default function SettingsModalWeb({
    visible,
    onClose,
    userName,
    userRole,
    ...
    const handleChangePassword = () => {
        onClose();
        router.push('/buddyrunner/change_password' as any);
    };
