...
const styles = StyleSheet.create({
    ...
    headerWeb: { fontSize: 18, fontWeight: '800', color: MAROON, marginLeft: 10, marginBottom: 4 },
    webContent: { width: '100%', alignSelf: 'center' },
    logoWeb: { width: 64, height: 64, alignSelf: 'center', marginTop: 16, marginBottom: 12 },

    labelWeb: { color: '#4a4a4a', fontWeight: '700', marginTop: 14, marginBottom: 6, fontSize: 12 },
    ...
    inputWeb: {
        ...
        } as any : { textAlignVertical: 'center' }),
    },
    inputWebPassword: {
        borderWidth: 1,
        borderColor: '#dddddd',
