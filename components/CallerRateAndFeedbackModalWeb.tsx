...
interface CallerRateAndFeedbackModalWebProps {
  visible: boolean;
  onClose: () => void;
  onSubmit: () => void;
  taskTitle: string;
...
const CallerRateAndFeedbackModalWeb: React.FC<CallerRateAndFeedbackModalWebProps> = ({
  visible,
  onClose,
  onSubmit,
  taskTitle,
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Save rating and feedback to database (Caller rating Runner)
...
export default CallerRateAndFeedbackModalWeb;