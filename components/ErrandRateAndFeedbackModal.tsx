...
interface ErrandRateAndFeedbackModalProps {
  visible: boolean;
  onClose: () => void;
  onSubmit: () => void;
  taskTitle?: string;
...
const ErrandRateAndFeedbackModal: React.FC<ErrandRateAndFeedbackModalProps> = ({
  visible,
  onClose,
  onSubmit,
  taskTitle,
...
export default ErrandRateAndFeedbackModal;
