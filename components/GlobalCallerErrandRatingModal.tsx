...
const GlobalCallerErrandRatingModal: React.FC = () => {
  ...
  useEffect(() => {
    console.log('GlobalCallerErrandRatingModal: Setting up subscription');
    const unsubscribe = callerErrandRatingService.subscribe((newNotification) => {
      console.log('GlobalCallerErrandRatingModal: Received notification:', newNotification);
      if (newNotification) {
        setNotification(newNotification);
        setVisible(true);
        console.log('GlobalCallerErrandRatingModal: Modal should be visible now');
      } else {
        setVisible(false);
        ...
        setFeedback('');
        setHoveredRating(0);
        console.log('GlobalCallerErrandRatingModal: Modal hidden');
      }
    });

    return () => {
      console.log('GlobalCallerErrandRatingModal: Cleaning up subscription');
      unsubscribe();
    };
  }, []);
...
export default GlobalCallerErrandRatingModal;
