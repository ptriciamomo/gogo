...
interface RateAndFeedbackModalWebProps {
  visible: boolean;
  onClose: () => void;
...
const RateAndFeedbackModalWeb: React.FC<RateAndFeedbackModalWebProps> = ({
  visible,
  onClose,
  onSubmit,
  taskTitle,
  ...
  const handleSubmit = async () => {
    if (!commissionId || !buddycallerId) {
      Alert.alert('Error', 'Missing commission or caller information.');
      return;
    }
...
export default RateAndFeedbackModalWeb;
